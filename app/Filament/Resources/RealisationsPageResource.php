...
use App\Filament\Resources\RealisationsPageResource\Pages;
use Livewire\Features\SupportFileUploads\TemporaryUploadedFile;
use Schmeits\FilamentCharacterCounter\Forms\Components\TextInput;
use App\Filament\Resources\RealisationsPageResource\RelationManagers;

class RealisationsPageResource extends Resource
{
    ...
    protected static ?string $model = RealisationsPage::class;
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('hero_heading')
                    ->label('Nagłowek')
                    ->description(function (RealisationsPage $record) {
    ...
    {
        return [
            'index' => Pages\ListRealisationsPages::route('/'),
            'create' => Pages\CreateRealisationsPage::route('/create'),
            'edit' => Pages\EditRealisationsPage::route('/{record}/edit'),
        ];
    }
